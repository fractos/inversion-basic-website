...
namespace Website.Code.Application
{
    public class DefaultHandler : IHttpHandler
    {
        /// <summary>
        /// Determines whether or not this handler can be reused.
        /// </summary>
        /// <value>
        ...
        {
            ProcessRequest((IWebContext)new AspNetContext(context, ServiceContainer.Instance, FileSystemResourceAdapter.Instance));
        }
